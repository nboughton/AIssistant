<template>
  <q-page class="column items-center justify-start" padding>
    <div class="row full-width items-center justify-evenly">
      <q-input class="col-grow q-mr-md" label="Text" filled v-model="text" autogrow clearable />
      <q-btn class="col-shrink" icon="mdi-play-circle" @click="app.speak(text)" flat rounded size="lg" />
    </div>
  </q-page>
</template>
